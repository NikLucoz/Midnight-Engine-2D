...
void GameEngine::render(float deltaTime) {
    ...
    debugUI_.Update(sf::seconds(deltaTime), runtimeInfo, [currentScene]() { currentScene->sDebugUI(); });
    debugUI_.Render();
...
const std::string &GameEngine::getCurrentSceneName() const { return currentScene_; }
